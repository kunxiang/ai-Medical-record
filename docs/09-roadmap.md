...
| 项 | 触发条件 |
|---|---|
| 原生 App | PWA 在拍照/录音上遇到硬限制。合规侧无阻力([12](./12-app-compliance.md)):**自用不上架**形态下 PIPL 家庭豁免适用,Claude API 与境外存储均可保留;一旦上架国内商店则回到 [11](./11-wechat-compliance.md) 的全部难题 |
| 微信小程序 | **已调研,见 [11 · 微信小程序合规](./11-wechat-compliance.md)** —— 结论:当前形态不可行(个人主体不开放类目 / Claude API 无算法备案 / 医疗类目资质拿不到)。触发条件改为:注册企业主体 + 切换境内已备案模型 + 接受功能降级为纯档案工具 |
| 儿童生长曲线 | 家里有孩子在用 |
| 多用户与档案共享 | 有第二个账号需要 |
